...
Debugging the Docker image tests can be harder than unit and jar tests. The `docker run` / `start-gretl.sh` command is printed on the console. Use this command to run the test in ther console by itself. Most probably you will get more information.
