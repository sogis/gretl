...
{{< include ./tasks/_ch.so.agi.gretl.tasks.CsvImport.md >}}
...
{{< include ./tasks/_ch.so.agi.gretl.tasks.FtpUpload.md >}}
...
{{< include ./tasks/_ch.so.agi.gretl.tasks.S3Delete.md >}}
...
Unterstützte Datenbanken: PostgreSQL, SQLite, Oracle, Derby und DuckDB. Für weitere Datenbanken 
muss der JDBC-Treiber als Abhängigkeit defininiert werden.
